  ...
  return (
    <section className="px-6 md:px-20 lg:px-40 py-12 md:py-20 bg-white">
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="relative overflow-hidden rounded-[3rem] bg-gradient-to-r from-[#10b981] via-[#1fbb32] to-[#16a34a] px-8 py-16 md:px-20 md:py-24 shadow-2xl shadow-[#1fbb32]/30">
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="flex-shrink-0 w-full md:w-auto">
              ...
              <button className="group relative w-full md:w-auto inline-flex items-center justify-center gap-3 bg-white hover:bg-[#f8fafc] text-[#1fbb32] px-8 py-5 rounded-2xl text-xl font-black transition-all hover:scale-105 active:scale-95 shadow-xl whitespace-nowrap">
                Join Now
